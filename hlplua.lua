...
{"for do"," - цикл повторения for i = 1,3 print(i) end - повторит цикл 3 раза и выведет на экран построчно 1 2 3. end  в конце указывает на заврешение цикла оператора"},
...
{""," - "},
{""," - "},
{"пример 1"," a = 1 /n b = 2 /n print(a+b) /n - выводит на экран 3"},
{""," - "},
{"exit"," - "},
}
st = 1
